import { n as __exportAll, t as __commonJSMin } from "./chunk-EAsCxrDo.js";
...
var createAddConnectionToAudioNode = (addActiveInputConnectionToAudioNode, addPassiveInputConnectionToAudioNode, connectNativeAudioNodeToNativeAudioNode, deleteActiveInputConnectionToAudioNode, disconnectNativeAudioNodeFromNativeAudioNode, getAudioNodeConnections, getAudioNodeTailTime, getEventListenersOfAudioNode, getNativeAudioNode, insertElementInSet, isActiveAudioNode, isPartOfACycle, isPassiveAudioNode) => {
	...
	return (source, destination, output, input, isOffline) => {
		...
		const eventListener = (isActive) => {
			...
			if (isActive) {
				addActiveInputConnectionToAudioNode(activeInputs, source, deletePassiveInputConnectionToAudioNode(passiveInputs, source, output, input), false);
				...
				addPassiveInputConnectionToAudioNode(passiveInputs, input, deleteActiveInputConnectionToAudioNode(activeInputs, source, output, input), false);
...
//#endregion
//#region node_modules/standardized-audio-context/build/es2019/factories/test-audio-buffer-copy-channel-methods-subarray-support.js
var createTestAudioBufferCopyChannelMethodsSubarraySupport = (nativeOfflineAudioContextConstructor) => {
	return () => {
		if (nativeOfflineAudioContextConstructor === null) return false;
		const nativeAudioBuffer = new nativeOfflineAudioContextConstructor(1, 1, 44100).createBuffer(1, 1, 44100);
		if (nativeAudioBuffer.copyToChannel === void 0) return true;
...
//#endregion
//#region node_modules/standardized-audio-context/build/es2019/factories/test-audio-context-close-method-support.js
var createTestAudioContextCloseMethodSupport = (nativeAudioContextConstructor) => {
	return () => {
		if (nativeAudioContextConstructor === null) return false;
		if (nativeAudioContextConstructor.prototype !== void 0 && nativeAudioContextConstructor.prototype.close !== void 0) return true;
...
//#endregion
//#region node_modules/standardized-audio-context/build/es2019/factories/test-audio-context-decode-audio-data-method-type-error-support.js
/**
* Edge up to version 14, Firefox up to version 52, Safari up to version 9 and maybe other browsers
* did not refuse to decode invalid parameters with a TypeError.
*/
var createTestAudioContextDecodeAudioDataMethodTypeErrorSupport = (nativeOfflineAudioContextConstructor) => {
	return () => {
		...
		return new Promise((resolve) => {
			...
			let promise;
			try {
				promise = offlineAudioContext.decodeAudioData(null, () => {}, resolvePromise);
			} catch (err) {
				resolvePromise(err);
			}
			if (promise !== void 0) promise.catch(resolvePromise);
		});
	};
};
//#endregion
//#region node_modules/standardized-audio-context/build/es2019/factories/test-audio-context-options-support.js
var createTestAudioContextOptionsSupport = (nativeAudioContextConstructor) => {
	return () => {
		if (nativeAudioContextConstructor === null) return false;
		let audioContext;
		try {
...
//#endregion
//#region node_modules/standardized-audio-context/build/es2019/factories/test-audio-node-connect-method-support.js
var createTestAudioNodeConnectMethodSupport = (nativeOfflineAudioContextConstructor) => {
	return () => {
		if (nativeOfflineAudioContextConstructor === null) return false;
		const nativeGainNode = new nativeOfflineAudioContextConstructor(1, 1, 44100).createGain();
...
//#endregion
//#region node_modules/standardized-audio-context/build/es2019/factories/test-audio-worklet-processor-no-outputs-support.js
/**
* Chrome version 66 and 67 did not call the process() function of an AudioWorkletProcessor if it had no outputs. AudioWorklet support was
* enabled by default in version 66.
*/
var createTestAudioWorkletProcessorNoOutputsSupport = (nativeAudioWorkletNodeConstructor, nativeOfflineAudioContextConstructor) => {
	return async () => {
		if (nativeAudioWorkletNodeConstructor === null) return true;
		if (nativeOfflineAudioContextConstructor === null) return false;
		const blob = new Blob(["let c,p;class A extends AudioWorkletProcessor{constructor(){super();this.port.onmessage=(e)=>{p=e.data;p.onmessage=()=>{p.postMessage(c);p.close()};this.port.postMessage(0)}}process(){c=1}}registerProcessor(\"a\",A)"], { type: "application/javascript; charset=utf-8" });
		const messageChannel = new MessageChannel();
...
//#endregion
//#region node_modules/standardized-audio-context/build/es2019/factories/test-channel-merger-node-channel-count-support.js
/**
* Firefox up to version 69 did not throw an error when setting a different channelCount or channelCountMode.
*/
var createTestChannelMergerNodeChannelCountSupport = (nativeOfflineAudioContextConstructor) => {
	return () => {
		if (nativeOfflineAudioContextConstructor === null) return false;
		const nativeChannelMergerNode = new nativeOfflineAudioContextConstructor(1, 1, 44100).createChannelMerger();
		/**
...
//#endregion
//#region node_modules/standardized-audio-context/build/es2019/factories/test-constant-source-node-accurate-scheduling-support.js
var createTestConstantSourceNodeAccurateSchedulingSupport = (nativeOfflineAudioContextConstructor) => {
	return () => {
		if (nativeOfflineAudioContextConstructor === null) return false;
		const nativeOfflineAudioContext = new nativeOfflineAudioContextConstructor(1, 1, 44100);
		if (nativeOfflineAudioContext.createConstantSource === void 0) return true;
		return nativeOfflineAudioContext.createConstantSource().offset.maxValue !== Number.POSITIVE_INFINITY;
	};
};
//#endregion
//#region node_modules/standardized-audio-context/build/es2019/factories/test-convolver-node-buffer-reassignability-support.js
var createTestConvolverNodeBufferReassignabilitySupport = (nativeOfflineAudioContextConstructor) => {
	return () => {
		if (nativeOfflineAudioContextConstructor === null) return false;
		const offlineAudioContext = new nativeOfflineAudioContextConstructor(1, 1, 44100);
...
//#endregion
//#region node_modules/standardized-audio-context/build/es2019/factories/test-convolver-node-channel-count-support.js
var createTestConvolverNodeChannelCountSupport = (nativeOfflineAudioContextConstructor) => {
	return () => {
		if (nativeOfflineAudioContextConstructor === null) return false;
		const nativeConvolverNode = new nativeOfflineAudioContextConstructor(1, 1, 44100).createConvolver();
		try {
...
//#endregion
//#region node_modules/standardized-audio-context/build/es2019/factories/test-is-secure-context-support.js
var createTestIsSecureContextSupport = (window) => {
	return () => window !== null && window.hasOwnProperty("isSecureContext");
};
//#endregion
//#region node_modules/standardized-audio-context/build/es2019/factories/test-media-stream-audio-source-node-media-stream-without-audio-track-support.js
var createTestMediaStreamAudioSourceNodeMediaStreamWithoutAudioTrackSupport = (nativeAudioContextConstructor) => {
	return () => {
		if (nativeAudioContextConstructor === null) return false;
		const audioContext = new nativeAudioContextConstructor();
		try {
...
//#endregion
//#region node_modules/standardized-audio-context/build/es2019/factories/test-stereo-panner-node-default-value-support.js
/**
* Firefox up to version 62 did not kick off the processing of the StereoPannerNode if the value of pan was zero.
*/
var createTestStereoPannerNodeDefaultValueSupport = (nativeOfflineAudioContextConstructor) => {
	return () => {
		if (nativeOfflineAudioContextConstructor === null) return Promise.resolve(false);
		const nativeOfflineAudioContext = new nativeOfflineAudioContextConstructor(1, 1, 44100);
		if (nativeOfflineAudioContext.createStereoPanner === void 0) return Promise.resolve(true);
		if (nativeOfflineAudioContext.createConstantSource === void 0) return Promise.resolve(true);
...
//#endregion
//#region node_modules/standardized-audio-context/build/es2019/helpers/test-dom-exception-constructor-support.js
...
//#endregion
//#region node_modules/standardized-audio-context/build/es2019/helpers/test-transferables-support.js
var testTransferablesSupport = () => new Promise((resolve) => {
	const arrayBuffer = /* @__PURE__ */ new ArrayBuffer(0);
	const { port1, port2 } = new MessageChannel();
...
function fanIn(...nodes) {
	...
	if (isDefined(dstNode)) nodes.forEach((node) => connect(node, dstNode));
}
//#endregion
...
Emitter.mixin(Clock);
//#endregion
//#region node_modules/tone/build/esm/core/context/Delay.js
/**
...
* }, 0.5, 1);
*/
var Delay = class Delay extends ToneAudioNode {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/core/context/Offline.js
/**
...
function Offline(callback_1, duration_1) {
	return __awaiter(this, arguments, void 0, function* (callback, duration, channels = 2, sampleRate = getContext().sampleRate) {
		...
		return new ToneAudioBuffer(yield bufferPromise);
	});
}
//#endregion
...
//#endregion
//#region node_modules/tone/build/esm/core/type/Units.js
...
//#endregion
//#region node_modules/tone/build/esm/source/Noise.js
/**
...
* @category Source
*/
var Noise = class Noise extends Source {
	constructor() {
	...
	*/
	_start(time) {
		...
		this._source.start(this.toSeconds(time), Math.random() * (buffer.duration - .001));
	}
	/**
		...
		if (!_noiseCache.brown) {
			...
			for (let channelNum = 0; channelNum < NUM_CHANNELS; channelNum++) {
				...
				for (let i = 0; i < BUFFER_LENGTH; i++) {
					...
					channel[i] = (lastOut + .02 * white) / 1.02;
					lastOut = channel[i];
					channel[i] *= 3.5;
				}
			}
		...
		if (!_noiseCache.pink) {
			...
			for (let channelNum = 0; channelNum < NUM_CHANNELS; channelNum++) {
				...
				for (let i = 0; i < BUFFER_LENGTH; i++) {
					...
					channel[i] = b0 + b1 + b2 + b3 + b4 + b5 + b6 + white * .5362;
					channel[i] *= .11;
					b6 = white * .115926;
				}
			}
...
//#endregion
//#region node_modules/tone/build/esm/source/UserMedia.js
/**
...
* @category Source
*/
var UserMedia = class UserMedia extends ToneAudioNode {
	constructor() {
	...
	*/
	open(labelOrId) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			if (isNumber(labelOrId)) this._device = devices[labelOrId];
			else {
			...
			if (this._device) constraints.audio.deviceId = this._device.deviceId;
	...
	*/
	static enumerateDevices() {
		return __awaiter(this, void 0, void 0, function* () {
			return (yield navigator.mediaDevices.enumerateDevices()).filter((device) => {
...
//#endregion
//#region node_modules/tone/build/esm/signal/Add.js
/**
...
* @category Signal
*/
var Add = class Add extends Signal {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/signal/Scale.js
/**
...
* @category Signal
*/
var Scale = class Scale extends SignalOperator {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/signal/Zero.js
/**
...
* @category Signal
*/
var Zero = class Zero extends SignalOperator {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/source/oscillator/LFO.js
/**
...
* @category Source
*/
var LFO = class LFO extends ToneAudioNode {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/source/buffer/Players.js
/**
* Players combines multiple {@link Player} objects.
* @category Source
*/
var Players = class Players extends ToneAudioNode {
	constructor() {
	...
	*/
	get state() {
		return Array.from(this._players).some(([_, player]) => player.state === "started") ? "started" : "stopped";
	}
	/**
	* True if the buffers object has a buffer by that name.
	* @param name  The key or index of the buffer.
...
//#endregion
//#region node_modules/tone/build/esm/source/buffer/GrainPlayer.js
/**
...
* @category Source
*/
var GrainPlayer = class GrainPlayer extends Source {
	constructor() {
	...
	*/
	...
	set loopStart(time) {
		if (this.buffer.loaded) assertRange(this.toSeconds(time), 0, this.buffer.duration);
...
//#endregion
//#region node_modules/tone/build/esm/signal/Abs.js
/**
...
//#endregion
//#region node_modules/tone/build/esm/signal/GainToAudio.js
/**
...
//#endregion
//#region node_modules/tone/build/esm/signal/Negate.js
/**
...
//#endregion
//#region node_modules/tone/build/esm/signal/Subtract.js
/**
...
* @category Signal
*/
var Subtract = class Subtract extends Signal {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/signal/GreaterThanZero.js
/**
...
* @category Signal
*/
var GreaterThanZero = class GreaterThanZero extends SignalOperator {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/signal/GreaterThan.js
/**
...
* @category Signal
*/
var GreaterThan = class GreaterThan extends Signal {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/signal/ScaleExp.js
/**
...
* @category Signal
*/
var ScaleExp = class ScaleExp extends Scale {
	constructor() {
		const options = optionsFromArguments(ScaleExp.getDefaults(), arguments, [
			"min",
			"max",
			"exponent"
		]);
	...
	static getDefaults() {
		return Object.assign(Scale.getDefaults(), { exponent: 1 });
	}
	/**
...
//#endregion
//#region node_modules/tone/build/esm/signal/SyncedSignal.js
/**
...
//#endregion
//#region node_modules/tone/build/esm/instrument/ModulationSynth.js
/**
* Base class for both AM and FM synths
*/
var ModulationSynth = class ModulationSynth extends Monophonic {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/instrument/AMSynth.js
/**
...
* @category Instrument
*/
var AMSynth = class AMSynth extends ModulationSynth {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/component/filter/BiquadFilter.js
/**
* Thin wrapper around the native Web Audio [BiquadFilterNode](https://webaudio.github.io/web-audio-api/#biquadfilternode).
* BiquadFilter is similar to {@link Filter} but doesn't have the option to set the "rolloff" value.
* @category Component
*/
var BiquadFilter = class BiquadFilter extends ToneAudioNode {
	constructor() {
	...
	*/
	...
	set type(type) {
		assert([
			...
			"allpass",
			"peaking"
		].indexOf(type) !== -1, `Invalid filter type: ${type}`);
	...
	*/
	getFrequencyResponse(len = 128) {
		...
		for (let i = 0; i < len; i++) freqValues[i] = Math.pow(i / len, 2) * 19980 + 20;
...
//#endregion
//#region node_modules/tone/build/esm/component/filter/Filter.js
/**
...
* @category Component
*/
var Filter = class Filter extends ToneAudioNode {
	constructor() {
	...
	*/
	...
	set rolloff(rolloff) {
		...
		for (let count = 0; count < cascadingCount; count++) {
			const filter = new BiquadFilter({ context: this.context });
	...
	*/
	getFrequencyResponse(len = 128) {
		...
		this._filters.forEach(() => {
			filterClone.getFrequencyResponse(len).forEach((val, i) => totalResponse[i] *= val);
		});
		filterClone.dispose();
...
//#endregion
//#region node_modules/tone/build/esm/component/envelope/FrequencyEnvelope.js
/**
...
* @category Component
*/
var FrequencyEnvelope = class FrequencyEnvelope extends Envelope {
	constructor() {
		const options = optionsFromArguments(FrequencyEnvelope.getDefaults(), arguments, [
			"attack",
			"decay",
			"sustain",
			"release"
...
//#endregion
//#region node_modules/tone/build/esm/instrument/MonoSynth.js
/**
...
* @category Instrument
*/
var MonoSynth = class MonoSynth extends Monophonic {
	constructor() {
	...
	static getDefaults() {
		return Object.assign(Monophonic.getDefaults(), {
			...
			oscillator: Object.assign(omitFromObject(OmniOscillator.getDefaults(), Object.keys(Source.getDefaults())), { type: "sawtooth" })
		});
	}
	/**
	* start the attack portion of the envelope
...
//#endregion
//#region node_modules/tone/build/esm/instrument/DuoSynth.js
/**
...
* @category Instrument
*/
var DuoSynth = class DuoSynth extends Monophonic {
	constructor() {
		...
		this.voice1 = new MonoSynth(Object.assign(options.voice1, { context: this.context }));
		this.harmonicity = new Multiply({
			context: this.context,
			units: "positive",
			value: options.harmonicity
...
//#endregion
//#region node_modules/tone/build/esm/instrument/FMSynth.js
/**
...
* @category Instrument
*/
var FMSynth = class FMSynth extends ModulationSynth {
	constructor() {
	...
	static getDefaults() {
		return Object.assign(ModulationSynth.getDefaults(), { modulationIndex: 10 });
	}
	dispose() {
		super.dispose();
		this.modulationIndex.dispose();
...
//#endregion
//#region node_modules/tone/build/esm/instrument/MetalSynth.js
/**
...
* @category Instrument
*/
var MetalSynth = class MetalSynth extends Monophonic {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/instrument/NoiseSynth.js
/**
...
* @category Instrument
*/
var NoiseSynth = class NoiseSynth extends Instrument {
	constructor() {
	...
	static getDefaults() {
		return Object.assign(Instrument.getDefaults(), {
			...
			noise: Object.assign(omitFromObject(Noise.getDefaults(), Object.keys(Source.getDefaults())), { type: "white" })
		});
	}
	/**
...
//#endregion
//#region node_modules/tone/build/esm/core/worklet/ToneAudioWorklet.js
...
`);
//#endregion
//#region node_modules/tone/build/esm/component/filter/FeedbackCombFilter.worklet.js
var workletName$1 = "feedback-comb-filter";
registerProcessor(workletName$1, `
...
`);
//#endregion
//#region node_modules/tone/build/esm/component/filter/FeedbackCombFilter.js
/**
...
* @category Component
*/
var FeedbackCombFilter = class FeedbackCombFilter extends ToneAudioWorklet {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/component/filter/OnePoleFilter.js
/**
...
* @category Component
*/
var OnePoleFilter = class OnePoleFilter extends ToneAudioNode {
	constructor() {
	...
	*/
	_createFilter() {
		...
		if (oldFilter) this.context.setTimeout(() => {
			if (!this.disposed) {
...
//#endregion
//#region node_modules/tone/build/esm/component/filter/LowpassCombFilter.js
/**
* A lowpass feedback comb filter. It is similar to
* {@link FeedbackCombFilter}, but includes a lowpass filter.
* @category Component
*/
var LowpassCombFilter = class LowpassCombFilter extends ToneAudioNode {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/instrument/PluckSynth.js
/**
...
* @category Instrument
*/
var PluckSynth = class PluckSynth extends Instrument {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/event/ToneEvent.js
/**
...
* @category Event
*/
var ToneEvent = class ToneEvent extends ToneWithContext {
	constructor() {
		...
		this._state.forEachFrom(after, (event) => {
			...
			if (event.state === "started") {
				...
				if (this._loop === true || isNumber(this._loop) && this._loop > 1) {
					duration = Infinity;
					if (isNumber(this._loop)) duration = this._loop * this._getLoopDuration();
					const nextEvent = this._state.getAfter(startTick);
					if (nextEvent !== null) duration = Math.min(duration, nextEvent.time - startTick);
					if (duration !== Infinity) duration = new TicksClass(this.context, duration);
				...
				} else event.id = this.context.transport.schedule(this._tick.bind(this), new TicksClass(this.context, startTick));
			}
		});
	}
	/**
	...
	*/
	_tick(time) {
		...
		if (!this.mute && this._state.getValueAtTime(ticks) === "started") {
			...
			if (this.humanize) {
				let variation = .02;
				if (!isBoolean(this.humanize)) variation = this.toSeconds(this.humanize);
	...
	get progress() {
		if (this._loop) {
			...
			if (lastEvent !== null && lastEvent.state === "started") {
				...
				return (ticks - lastEvent.time) % loopDuration / loopDuration;
			} else return 0;
		} else return 0;
	}
	dispose() {
...
//#endregion
//#region node_modules/tone/build/esm/event/Loop.js
/**
...
* @category Event
*/
var Loop = class Loop extends ToneWithContext {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/event/Part.js
/**
...
* @category Event
*/
var Part = class Part extends ToneEvent {
	constructor() {
		...
		*/
		...
		options.events.forEach((event) => {
			if (isArray(event)) this.add(event[0], event[1]);
			else this.add(event);
		});
	}
	static getDefaults() {
		return Object.assign(ToneEvent.getDefaults(), { events: [] });
	}
	/**
	...
	_startNote(event, ticks, offset) {
		...
		if (this._loop) {
			if (event.startOffset >= this._loopStart && event.startOffset < this._loopEnd) {
				if (event.startOffset < offset) ticks += this._getLoopDuration();
				event.start(new TicksClass(this.context, ticks));
			} else if (event.startOffset < this._loopStart && event.startOffset >= offset) {
				event.loop = false;
				event.start(new TicksClass(this.context, ticks));
			}
		} else if (event.startOffset >= offset) event.start(new TicksClass(this.context, ticks));
	}
	get startOffset() {
		return this._startOffset;
	}
	...
	at(time, value) {
		...
		while (!result.done) {
			...
			if (Math.abs(timeInTicks - event.startOffset) < tickTime) {
				if (isDefined(value)) event.value = value;
				return event;
			}
	...
	*/
	_restartEvent(event) {
		this._state.forEach((stateEvent) => {
			...
			else event.stop(new TicksClass(this.context, stateEvent.time));
		});
	}
	remove(time, value) {
	...
	*/
	_testLoopBoundries(event) {
		...
		else if (event.state === "stopped") this._restartEvent(event);
	}
	get probability() {
		return this._probability;
	}
...
//#endregion
//#region node_modules/tone/build/esm/event/PatternGenerator.js
/**
...
function* randomGen(numValues) {
	while (true) yield Math.floor(Math.random() * numValues);
}
/**
...
function* randomOnce(numValues) {
	...
	while (copy.length > 0) yield clamp(copy.splice(Math.floor(copy.length * Math.random()), 1)[0], 0, numValues - 1);
}
/**
...
function* PatternGenerator(numValues, pattern = "up", index = 0) {
	...
	switch (pattern) {
		case "up": yield* infiniteGen(numValues, upPatternGen);
		case "down": yield* infiniteGen(numValues, downPatternGen);
		case "upDown": yield* alternatingGenerator(numValues, true);
		case "downUp": yield* alternatingGenerator(numValues, false);
		case "alternateUp": yield* infiniteGen(numValues, jumpUp);
		case "alternateDown": yield* infiniteGen(numValues, jumpDown);
		case "random": yield* randomGen(numValues);
		case "randomOnce": yield* infiniteGen(numValues, randomOnce);
		case "randomWalk": yield* randomWalk(numValues);
	}
}
//#endregion
//#region node_modules/tone/build/esm/event/Pattern.js
/**
...
* @category Event
*/
var Pattern = class Pattern extends Loop {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/event/Sequence.js
/**
...
* @category Event
*/
var Sequence = class Sequence extends ToneEvent {
	constructor() {
		const options = optionsFromArguments(Sequence.getDefaults(), arguments, [
			"callback",
			"events",
			"subdivision"
		]);
	...
	_createSequence(array) {
		return new Proxy(array, {
			...
			set: (target, property, value) => {
				if (isString(property) && isFinite(parseInt(property, 10))) if (isArray(value)) target[property] = this._createSequence(value);
	...
	*/
	_rescheduleSequence(sequence, subdivision, startOffset) {
		sequence.forEach((value, index) => {
			...
			if (isArray(value)) this._rescheduleSequence(value, subdivision / value.length, eventOffset);
			else {
...
//#endregion
//#region node_modules/tone/build/esm/component/channel/CrossFade.js
/**
...
* @category Component
*/
var CrossFade = class CrossFade extends ToneAudioNode {
	constructor() {
	...
	static getDefaults() {
		return Object.assign(ToneAudioNode.getDefaults(), { fade: .5 });
	}
	dispose() {
		super.dispose();
		this.a.dispose();
...
//#endregion
//#region node_modules/tone/build/esm/effect/Effect.js
/**
...
var Effect = class extends ToneAudioNode {
	...
	static getDefaults() {
		return Object.assign(ToneAudioNode.getDefaults(), { wet: 1 });
	}
	/**
...
//#endregion
//#region node_modules/tone/build/esm/effect/LFOEffect.js
/**
...
//#endregion
//#region node_modules/tone/build/esm/effect/AutoFilter.js
/**
...
* @category Effect
*/
var AutoFilter = class AutoFilter extends LFOEffect {
	constructor() {
		const options = optionsFromArguments(AutoFilter.getDefaults(), arguments, [
			"frequency",
			"baseFrequency",
			"octaves"
		]);
...
//#endregion
//#region node_modules/tone/build/esm/effect/AutoPanner.js
/**
...
* @category Effect
*/
var AutoPanner = class AutoPanner extends LFOEffect {
	constructor() {
	...
	static getDefaults() {
		return Object.assign(LFOEffect.getDefaults(), { channelCount: 1 });
	}
	dispose() {
		super.dispose();
...
//#endregion
//#region node_modules/tone/build/esm/component/analysis/Follower.js
/**
...
* @category Component
*/
var Follower = class Follower extends ToneAudioNode {
	constructor() {
	...
	static getDefaults() {
		return Object.assign(ToneAudioNode.getDefaults(), { smoothing: .05 });
	}
	/**
...
//#endregion
//#region node_modules/tone/build/esm/effect/AutoWah.js
/**
...
* @category Effect
*/
var AutoWah = class AutoWah extends Effect {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/effect/BitCrusher.worklet.js
...
`);
//#endregion
//#region node_modules/tone/build/esm/effect/BitCrusher.js
/**
...
* @category Effect
*/
var BitCrusher = class BitCrusher extends Effect {
	constructor() {
	...
	static getDefaults() {
		return Object.assign(Effect.getDefaults(), { bits: 4 });
	}
	dispose() {
		super.dispose();
...
*/
var BitCrusherWorklet = class BitCrusherWorklet extends ToneAudioWorklet {
	constructor() {
	...
	static getDefaults() {
		return Object.assign(ToneAudioWorklet.getDefaults(), { bits: 12 });
	}
	_audioWorkletName() {
		return workletName;
	}
...
//#endregion
//#region node_modules/tone/build/esm/effect/Chebyshev.js
/**
...
* @category Effect
*/
var Chebyshev = class Chebyshev extends Effect {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/component/channel/Split.js
/**
...
* @category Component
*/
var Split = class Split extends ToneAudioNode {
	constructor() {
	...
	static getDefaults() {
		return Object.assign(ToneAudioNode.getDefaults(), { channels: 2 });
	}
	dispose() {
		super.dispose();
...
//#endregion
//#region node_modules/tone/build/esm/component/channel/Merge.js
/**
...
* @category Component
*/
var Merge = class Merge extends ToneAudioNode {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/effect/StereoEffect.js
/**
...
//#endregion
//#region node_modules/tone/build/esm/effect/StereoFeedbackEffect.js
/**
...
var StereoFeedbackEffect = class extends StereoEffect {
	...
	static getDefaults() {
		return Object.assign(StereoEffect.getDefaults(), { feedback: .5 });
	}
	dispose() {
		super.dispose();
...
//#endregion
//#region node_modules/tone/build/esm/effect/Chorus.js
/**
...
* @category Effect
*/
var Chorus = class Chorus extends StereoFeedbackEffect {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/effect/Distortion.js
/**
...
* @category Effect
*/
var Distortion = class Distortion extends Effect {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/effect/FeedbackEffect.js
/**
...
var FeedbackEffect = class extends Effect {
	...
	static getDefaults() {
		return Object.assign(Effect.getDefaults(), { feedback: .125 });
	}
	dispose() {
		super.dispose();
...
//#endregion
//#region node_modules/tone/build/esm/effect/FeedbackDelay.js
/**
...
* @category Effect
*/
var FeedbackDelay = class FeedbackDelay extends FeedbackEffect {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/component/filter/PhaseShiftAllpass.js
/**
...
//#endregion
//#region node_modules/tone/build/esm/effect/FrequencyShifter.js
/**
...
* @category Effect
*/
var FrequencyShifter = class FrequencyShifter extends Effect {
	constructor() {
	...
	static getDefaults() {
		return Object.assign(Effect.getDefaults(), { frequency: 0 });
	}
	dispose() {
		super.dispose();
		this.frequency.dispose();
...
//#endregion
//#region node_modules/tone/build/esm/effect/Freeverb.js
/**
...
* @category Effect
*/
var Freeverb = class Freeverb extends StereoEffect {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/effect/JCReverb.js
/**
...
* @category Effect
*/
var JCReverb = class JCReverb extends StereoEffect {
	constructor() {
	...
	static getDefaults() {
		return Object.assign(StereoEffect.getDefaults(), { roomSize: .5 });
	}
	dispose() {
		super.dispose();
...
//#endregion
//#region node_modules/tone/build/esm/effect/StereoXFeedbackEffect.js
/**
...
//#endregion
//#region node_modules/tone/build/esm/effect/PingPongDelay.js
/**
...
* @category Effect
*/
var PingPongDelay = class PingPongDelay extends StereoXFeedbackEffect {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/effect/PitchShift.js
/**
...
* @category Effect
*/
var PitchShift = class PitchShift extends FeedbackEffect {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/effect/Phaser.js
/**
...
* @category Effect
*/
var Phaser = class Phaser extends StereoEffect {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/effect/Reverb.js
/**
...
* @category Effect
*/
var Reverb = class Reverb extends Effect {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/component/channel/MidSideSplit.js
/**
...
* @category Component
*/
var MidSideSplit = class MidSideSplit extends ToneAudioNode {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/component/channel/MidSideMerge.js
/**
...
* @category Component
*/
var MidSideMerge = class MidSideMerge extends ToneAudioNode {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/effect/MidSideEffect.js
/**
...
//#endregion
//#region node_modules/tone/build/esm/effect/StereoWidener.js
/**
...
* @category Effect
*/
var StereoWidener = class StereoWidener extends MidSideEffect {
	constructor() {
	...
	static getDefaults() {
		return Object.assign(MidSideEffect.getDefaults(), { width: .5 });
	}
	dispose() {
		super.dispose();
		this.width.dispose();
...
//#endregion
//#region node_modules/tone/build/esm/effect/Tremolo.js
/**
...
* @category Effect
*/
var Tremolo = class Tremolo extends StereoEffect {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/effect/Vibrato.js
/**
* A Vibrato effect composed of a Tone.Delay and a Tone.LFO. The LFO
* modulates the delayTime of the delay, causing the pitch to rise and fall.
* @category Effect
*/
var Vibrato = class Vibrato extends Effect {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/component/analysis/Analyser.js
/**
* Wrapper around the native Web Audio's [AnalyserNode](http://webaudio.github.io/web-audio-api/#idl-def-AnalyserNode).
* Extracts FFT or Waveform data from the incoming signal.
* @category Component
*/
var Analyser = class Analyser extends ToneAudioNode {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/component/analysis/MeterBase.js
/**
* The base class for Metering classes.
*/
var MeterBase = class MeterBase extends ToneAudioNode {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/component/analysis/Meter.js
/**
...
* @category Component
*/
var Meter = class Meter extends MeterBase {
	constructor() {
	...
	*/
	getValue() {
		...
		const vals = (this.channels === 1 ? [aValues] : aValues).map((values, index) => {
...
//#endregion
//#region node_modules/tone/build/esm/component/analysis/DCMeter.js
/**
...
* @category Component
*/
var DCMeter = class DCMeter extends MeterBase {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/component/analysis/Waveform.js
/**
* Get the current waveform data of the connected audio source.
* @category Component
*/
var Waveform = class Waveform extends MeterBase {
	constructor() {
	...
	static getDefaults() {
		return Object.assign(MeterBase.getDefaults(), { size: 1024 });
	}
	/**
...
//#endregion
//#region node_modules/tone/build/esm/component/channel/Mono.js
/**
...
* @category Component
*/
var Mono = class Mono extends ToneAudioNode {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/component/channel/MultibandSplit.js
/**
...
* @category Component
*/
var MultibandSplit = class MultibandSplit extends ToneAudioNode {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/component/channel/Panner3D.js
/**
* A spatialized panner node which supports equalpower or HRTF panning.
* @category Component
*/
var Panner3D = class Panner3D extends ToneAudioNode {
	constructor() {
		const options = optionsFromArguments(Panner3D.getDefaults(), arguments, [
			"positionX",
			"positionY",
			"positionZ"
		]);
...
//#endregion
//#region node_modules/tone/build/esm/component/channel/Recorder.js
/**
...
* @category Component
*/
var Recorder = class Recorder extends ToneAudioNode {
	constructor() {
		...
		this._recorder = new MediaRecorder(this._stream.stream, { mimeType: options.mimeType });
	}
	static getDefaults() {
...
//#endregion
//#region node_modules/tone/build/esm/component/dynamics/Compressor.js
/**
...
* @category Component
*/
var Compressor = class Compressor extends ToneAudioNode {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/component/dynamics/Gate.js
/**
...
* @category Component
*/
var Gate = class Gate extends ToneAudioNode {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/component/dynamics/Limiter.js
/**
...
* @category Component
*/
var Limiter = class Limiter extends ToneAudioNode {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/component/dynamics/MidSideCompressor.js
/**
...
* @category Component
*/
var MidSideCompressor = class MidSideCompressor extends ToneAudioNode {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/component/dynamics/MultibandCompressor.js
/**
...
* @category Component
*/
var MultibandCompressor = class MultibandCompressor extends ToneAudioNode {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/component/filter/EQ3.js
/**
* EQ3 provides 3 equalizer bins: Low/Mid/High.
* @category Component
*/
var EQ3 = class EQ3 extends ToneAudioNode {
	constructor() {
...
//#endregion
//#region node_modules/tone/build/esm/component/filter/Convolver.js
/**
...
* @category Component
*/
var Convolver = class Convolver extends ToneAudioNode {
	constructor() {
