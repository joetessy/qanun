...
export const LOWER_JINS: readonly LowerJins[] = [
  ...
  { id: 'saba',     label: 'Saba',     homeDegree: 2, defaultScale: [0, 2, 3.5, 5, 6, 9, 10],    upperOptions: ['hijaz', 'ajam'] },
  { id: 'sikah',    label: 'Sikah',    homeDegree: 3, defaultScale: [0, 2, 3.5, 5, 7, 9, 10.5],  upperOptions: ['rast', 'nahawand', 'hijaz', 'bayati'] }
]
